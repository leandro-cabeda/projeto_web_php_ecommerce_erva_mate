...
//título do relatório
$objeto->Cell(190,10,utf8_decode('RELATÓRIO DE FORNECEDORES'),0,1,'C',0); 
...
$objeto->Cell(25,15,'RAZAO',1,0,'C',1);
$objeto->Cell(30,15,'CNPJ',1,0,'C',1);
$objeto->Cell(60,15,'EMAIL',1,0,'C',1);
$objeto->Cell(25,15,'CIDADE',1,1,'C',1);
...
while($reg = $res->FetchNextObject())
{
    ...
    $objeto->Cell(25,10,$reg->RAZAO,1,0,'C',0);
    $objeto->Cell(30,10,$reg->CNPJ,1,0,'C',0);
    $objeto->Cell(60,10,$reg->EMAIL,1,0,'C',0);
    $objeto->Cell(25,10,$reg->CIDADE,1,1,'C',0);  
    $x++;
} 
