...
//título do relatório
$objeto->Cell(190,10,utf8_decode('RELATÓRIO DE CLIENTES_PRODUTOS'),0,1,'C',0);
...
$objeto->Cell(35,15,'CLIENTE',1,0,'C',1);
$objeto->Cell(35,15,'PRODUTO',1,0,'C',1);
$objeto->Cell(35,15,'QUANTIDADE',1,0,'C',1);
$objeto->Cell(35,15,'TOTAL',1,1,'C',1);

$mod = new conecta();
$sql = "select * from cli_prod";
...
while($reg = $res->FetchNextObject())
{
    ...
    $objeto->Cell(35,10,$reg->CLI,1,0,'C',0);
    $objeto->Cell(35,10,$reg->PROD,1,0,'C',0);
    $objeto->Cell(35,10,$reg->QTD,1,0,'C',0);
    $objeto->Cell(35,10,$reg->TOTAL,1,1,'C',0);  
    $x++;
} 
