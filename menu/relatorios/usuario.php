...
//título do relatório
$objeto->Cell(190,10,utf8_decode('RELATÓRIO DE USUÁRIOS'),0,1,'C',0); 
...
$objeto->Cell(30,15,'LOGIN',1,0,'C',1);
$objeto->Cell(25,15,'DATA',1,0,'C',1);
$objeto->Cell(25,15,'ACESSOS',1,0,'C',1);
$objeto->Cell(60,15,'EMAIL',1,1,'C',1);
...
while($reg = $res->FetchNextObject())
{
    ...
    $objeto->Cell(30,10,$reg->LOGIN,1,0,'C',0);
    $objeto->Cell(25,10,$reg->DAT,1,0,'C',0);
    $objeto->Cell(25,10,$reg->NUM_ACESSO,1,0,'C',0);
    $objeto->Cell(60,10,$reg->EMAIL,1,1,'C',0);  
    $x++;
} 
