...
<head>
   <script type="text/javascript">
    ...
    function preparar(){
            ...
            document.getElementById("operacao").innerHTML = "Listagem de Produtos";
        }
    </script>
    ...
    <div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          ...
          <h2 id="operacao" style="text-align: center; color: blue; font-weight: bold;"></h2>
           <a id="novo" class="btn btn-lg btn-success" href="?menu=produtos&acao=incluir">Novo</a><br>
              ...
              <tbody>
               <?php
                ...
                <tr style="color: white;background-color: black;">
                  ...
                  <td><?php echo $reg->FORNE ?></td>
                  <td><?php echo $reg->QTD; ?></td>
                  <td><img src="../images/<?php echo $reg->IMG != '' ? $reg->IMG : 'indisponivel.jpg';?>" border="0" width="70" height="40"></td>
                  <td><?php echo $reg->CUSTO; ?></td>
                  <td class="actions">
                    <a class="btn btn-warning btn-xs" href="?menu=produtos&acao=alterar&id=<?php echo $reg->COD; ?>">Editar</a>
                    <a class="btn btn-danger btn-xs" data-href="?menu=produtos&acao=excluir&id=<?php echo $reg->COD; ?>" data-toggle="modal" data-target="#confirm-delete">Excluir</a>
                 </td>
                </tr>
                <?php
                    }
